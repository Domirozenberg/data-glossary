...
- [Data Pipeline Best Practices](../cross-cutting/data-pipeline-best-practices.md) (documentation and versioning of pipeline code)
- [Data Versioning](../advanced/data-versioning.md) (versioning datasets and models)
