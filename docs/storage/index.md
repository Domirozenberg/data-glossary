...
Storage concepts and strategies: object storage, partitioning, tiering, retention, and lifecycle management.
...
- [Hybrid Storage](hybrid-storage.md)
- [Object Storage](object-storage.md)
- [Row Based Storage](row-based-storage.md)
- [Storage Compression](storage-compression.md)
