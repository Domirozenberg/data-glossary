...
Cleansing, normalization, enrichment, schema evolution, and other transformation techniques.
...
- [Data Denormalization](data-denormalization.md)
...
- [Data Pivoting Unpivoting](data-pivoting-unpivoting.md)
