...
- Data Validity (syntax and format correctness)
- Data Consistency (agreement across systems and fields)
- Data Quality Metrics (measuring accuracy)
- Data Profiling (discovering accuracy issues)
- Data Quality Gates (enforcing accuracy before use)
